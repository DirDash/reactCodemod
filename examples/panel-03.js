...
storiesOf('confirmit-react-components/Panel', module)
  ...
  .add('[DEPRECATED] collapsible / expanded', () => (
    <Panel>
      <Panel.Header><Panel.Toggle><Panel.Title>Can collapse</Panel.Title></Panel.Toggle><Panel.Actions><Panel.Toggle /></Panel.Actions></Panel.Header>
  ...
  .add('[DEPRECATED] collapsible / collapsed', () => (
    <Panel defaultCollapsed>
      <Panel.Header><Panel.Toggle><Panel.Title>Can expand</Panel.Title></Panel.Toggle><Panel.Actions><Panel.Toggle /></Panel.Actions></Panel.Header>
  ...
  .add('[DEPRECATED] collapsible / custom children', () => (
    <Panel>
      <Panel.Header><Panel.Toggle><Panel.Title>With Footer</Panel.Title></Panel.Toggle>
        <span>Extra children</span>
        <Panel.Actions><Panel.Toggle /></Panel.Actions></Panel.Header>
